...
runs the bisection search for start size (see Section 3.4) for the Target Model
(Chapter 4).
...
if __name__ == "__main__":
    ...
    parser.add_argument('-out_directory', '--out_directory', type=str, default='start_size')
